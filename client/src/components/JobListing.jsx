...
const JobListing = () => {
    ...
    return (
        <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
            ...
            <div className="sidebar w-full lg:w-1/4 bg-white px-4">
                    ...
                    isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
                        <>
                            ...
                            <div className='mb-4 text-gray-600 flex'>
                                {searchFilter.title && (
                                    <span className='flex items-center text-xs gap-2.5 bg-blue-50 border border-blue-200 px-2 py-1.5 rounded'>
                                        {searchFilter.title}
                                ...
                                {searchFilter.location && (
                                    <span className='flex items-center text-xs gap-2.5 bg-red-50 border border-red-200 px-2 py-1.5 rounded'>
                                        {searchFilter.location}
            ...
            <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4 '>
                ...
                {jobs.length > 0 && (
                    <div className='flex items-center justify-center space-x-2 mt-10'>
                        <a href='#job-list'>
                            <img onClick={()=> setCurrentPage(Math.max(currentPage-1).toExponential,1)} src={assets.left_arrow_icon} alt="" />
                        </a>
